...
Gothic.create = function(di)
	...
	var glassTemplate = new GothicOutline(this.getFloat("MasonsOpeningWidth"),
			this.getFloat("MasonsOpeningHeight"), this.getFloat("Radius"), this
					.getFloat("Allowance")
					+ this.getFloat("FrameCRelativeWidth")
					/ 2
					+ this.getFloat("FrameCBarWidth")
					- this.getFloat("GlassOverlap"), offset(this.root,
					maxWidth, -1));
	glassTemplate.setCrossBar(false);
	...
	this.createFrameA(di, ao, offset(this.root, maxWidth, 1));

	this.createFrameC(di, ao, offset(this.root, maxWidth, 2));

	this.createCappedArch(di, ao, offset(this.root, maxWidth, 3));

	this.createFullSideBar(di, ao, offset(this.root, maxWidth, 4));

	this.createSplitSideBar(di, ao, offset(this.root, maxWidth, 5));

	this.createBottomBar(di, ao, offset(this.root, maxWidth, 6));

	this.createSimpleBars(di, ao, offset(this.root, maxWidth, 7));
	...
	var txt = new Text("Glass Template", offset(this.root, maxWidth, -1), 8, 4,
			0, "Text");
	txt.render(di, ao);
	...
	var txt = new Text("Masons opening as measured", offset(this.root,
			maxWidth, 0), 8, 4, 0, "Text");
	txt.render(di, ao);
	...
	txt = new Text("Capped Arch", offset(this.root, maxWidth, 3), 8, 4, 0,
			"Text");
	txt.render(di, ao);

	txt = new Text("Full Sidebar", offset(this.root, maxWidth, 4), 8, 4, 0,
			"Text");
	txt.render(di, ao);

	txt = new Text("Split Sidebar", offset(this.root, maxWidth, 5), 8, 4, 0,
			"Text");
	txt.render(di, ao);

	txt = new Text("Bottom Bar", offset(this.root, maxWidth, 6), 8, 4, 0,
			"Text");
	txt.render(di, ao);

	txt = new Text("Simple Bars", offset(this.root, maxWidth, 7), 8, 4, 0,
			"Text");
	txt.render(di, ao);

	txt = new Text("Hole centre spacing on arc "
			+ this.holeArc.getLinearSpacing(), offset(this.root, maxWidth, 3)
			.operator_add(new RVector(0, 1000)), 8, 4, 0, "Text");
	txt.render(di, ao);
	...
	txt = new Text("JOB Ref: " + ui.getText("CustomerName"), offset(this.root,
			maxWidth, 1).operator_add(new RVector(100, 20)), 8, 4, 0, "Etching");
	txt.render(di, ao);
	//
	//	
	// createText(di, ao, offset(this.root, maxWidth, 1).operator_add(new
	// RVector(100,20)),
	...
	txt = new Text("JOB Ref: " + ui.getText("CustomerName"), offset(this.root,
			maxWidth, 2).operator_add(
			new RVector(100, ui.getFloat("FrameCRelativeWidth") + 7)), 6, 3, 0,
			"Etching");
	txt.render(di, ao);
	...
	txt = new Text("JOB Ref: " + ui.getText("CustomerName"), offset(this.root,
			maxWidth, 3).operator_add(new RVector(-10, 10)), 4, 2,
			0.95 * Math.PI / 2, "Etching");
	txt.render(di, ao);

	// Full side bar

	txt = new Text(ui.getText("CustomerName"), offset(this.root, maxWidth, 4)
			.operator_add(
					new RVector(-10, -10 + ui.getFloat("FrameCBarWidth") / 2)),
			2, 1, Math.PI / 2, "Etching");
	txt.render(di, ao);
	// Split side bars

	txt = new Text(ui.getText("CustomerName"), offset(this.root, maxWidth, 5)
			.operator_add(
					new RVector(-10, 15 + ui.getFloat("FrameCBarWidth") / 2)),
			2, 1, Math.PI / 2, "Etching");
	txt.render(di, ao);

	txt = new Text(ui.getText("CustomerName"), offset(this.root, maxWidth, 5)
			.operator_add(
					new RVector(-10, ui.hingeAssembly.getBottomHingeCentre()
							.getY()
							+ ui.getFloat("HingeHoleClearance") + 15)), 2, 1,
			Math.PI / 2, "Etching");
	txt.render(di, ao);

	txt = new Text(ui.getText("CustomerName"), offset(this.root, maxWidth, 5)
			.operator_add(
					new RVector(-10, ui.hingeAssembly.getMiddleHingeCentre()
							.getY()
							+ ui.getFloat("HingeHoleClearance") + 15)), 2, 1,
			Math.PI / 2, "Etching");
	txt.render(di, ao);
	...
	txt = new Text(ui.getText("CustomerName"), offset(this.root, maxWidth, 5)
			.operator_add(
					new RVector(-10, ui.hingeAssembly.getTopHingeCentre()
							.getY()
							+ ui.getFloat("HingeHoleClearance") + 15)), 2, 1,
			Math.PI / 2, "Etching");
	txt.render(di, ao);
	...
	txt = new Text(ui.getText("CustomerName"), offset(this.root, maxWidth, 6)
			.operator_add(
					new RVector(-10, -10 + ui.getFloat("FrameCBarWidth") / 2)),
			2, 1, Math.PI / 2, "Etching");
	txt.render(di, ao);
	...
	txt = new Text("JOB Ref: " + ui.getText("CustomerName"), offset(this.root,
			maxWidth, 7).operator_add(
			new RVector(10, 15 + ui.getFloat("FrameCBarWidth") / 2)), 3, 1.5,
			Math.PI / 2, "Etching");
	txt.render(di, ao);

	txt = new Text("JOB Ref: " + ui.getText("CustomerName"), offset(this.root,
			maxWidth, 7).operator_add(
			new RVector(40, 15 + ui.getFloat("FrameCBarWidth") / 2)), 3, 1.5,
			Math.PI / 2, "Etching");
	txt.render(di, ao);

	txt = new Text("JOB Ref: " + ui.getText("CustomerName"), offset(this.root,
			maxWidth, 7).operator_add(
			new RVector(70, 15 + ui.getFloat("FrameCBarWidth") / 2)), 3, 1.5,
			Math.PI / 2, "Etching");
	txt.render(di, ao);

	txt = new Text("JOB Ref: " + ui.getText("CustomerName"), offset(this.root,
			maxWidth, 7).operator_add(
			new RVector(100, 15 + ui.getFloat("FrameCBarWidth") / 2)), 3, 1.5,
			Math.PI / 2, "Etching");
	txt.render(di, ao);
...
// ********************************************************************************************************************
	...
	var frameAInner = new GothicOutline(width, height, radius, this
			.getFloat("ArchBarWidth")
			+ allowance, pos);

	if (ui.widgets["FrameACrossBar"].checked)
		{
		frameAInner.setCrossBar(true);
		}

	frameAInner.render(di, ao);

	createGothicArchRel(di, ao, pos, radius, width, height, allowance, topOnly);
	...
	this.createFrameAOutline(di, ao, frameARoot, width, spring + allowance);
	...
	var rhendPos = frameARoot.operator_add(new RVector(width + 2 * allowance
			- this.getFloat("PlasticHoleMargin"),
			this.hingeAssembly.bottomHingeCentre.getY()
					- this.getFloat("PlasticHoleInset")));
	...
	if (ui.widgets["ThirdHinge"].checked)
		...
		rhendPos = frameARoot.operator_add(new RVector(width + 2 * allowance
				- this.getFloat("PlasticHoleMargin"),
				this.hingeAssembly.middleHingeCentre.getY()
						- this.getFloat("PlasticHoleInset")));
		...
		rhendPos = frameARoot.operator_add(new RVector(width + 2 * allowance
				- this.getFloat("PlasticHoleMargin"),
				this.hingeAssembly.topHingeCentre.getY()
						- this.getFloat("PlasticHoleInset")));
...
// This bit is quite complex - pulled out into its own methid just to maike it a
// bit more tractable to understand

Gothic.createFrameAOutline = function(di, ao, pos, width, spring)
	{
	var height = this.getFloat("MasonsOpeningHeight")
	...
	var leftHand = new Array(pos.operator_add(new RVector(cutoutWidth
			- bendReliefSlotWidth, cutoutHeight)), pos
			.operator_add(new RVector(0, cutoutHeight)), pos
	...
	this.hingeAssembly = new HingeAssembly(new RVector(0, 0), new RVector(0,
			spring - this.getFloat("BendSlotHeight") - cutoutHeight));
	this.hingeAssembly.renderTabs(di, ao, pos.operator_add(new RVector(width
			+ 2 * allowance, cutoutHeight)));

	var bottomRight = new Array(pos.operator_add(new RVector(width + 2
			* allowance, cutoutHeight)), pos.operator_add(new RVector(width + 2
			* allowance - cutoutWidth + bendReliefSlotWidth, cutoutHeight)));
	...
	createVBendRelief(di, ao, pos.operator_add(new RVector(cutoutWidth
			- bendReliefSlotWidth, cutoutHeight)), 1, 1, diameter, slotWidth,
			slotLength);

	createVBendRelief(di, ao, pos.operator_add(new RVector(width + 2
			* allowance - cutoutWidth, cutoutHeight)), 1, -1, diameter,
...
Gothic.createFrameC = function(di, ao, pos)
	...
	createGothicArchRel(di, ao, pos, radius, width, height, allowance);
	...
	var frameCInner = new GothicOutline(width, height, radius, allowance
			+ this.getFloat("FrameCBarWidth"), pos);
	if (ui.widgets["FrameCCrossBar"].checked)
		{
		frameCInner.setCrossBar(true);
		}
	frameCInner.render(di, ao);

	// special case so have to set up inset ourselves
	var weldTabBarHeight = getGothicSpring(radius, width, height)
			- allowance
			- this.getFloat("FrameCBarWidth")
			/ 2
			- this.getFloat("WeldLugHoleWidth")
			/ 2
			- this.getFloat("WeldLugHoleClearance")
			- (this.getFloat("WeldLugInset") - this
					.getFloat("WeldLugHoleClearance") * 2)
			- (this.getFloat("WeldLugInset") - this
					.getFloat("WeldLugHoleClearance"));

	var startPos = pos.operator_add(new RVector(allowance
			+ this.getFloat("FrameCBarWidth") / 2, allowance
			+ this.getFloat("FrameCBarWidth") / 2
			+ this.getFloat("WeldLugHoleWidth") / 2
			+ this.getFloat("WeldLugHoleClearance")));

	var endPos = pos.operator_add(new RVector(allowance
			+ this.getFloat("FrameCBarWidth") / 2, getGothicSpring(radius,
			width, height)));
	...
	startPos = pos.operator_add(new RVector(width - allowance
			- this.getFloat("FrameCBarWidth") / 2, allowance
			+ this.getFloat("FrameCBarWidth") / 2
			+ this.getFloat("WeldLugHoleWidth") / 2));

	endPos = startPos.operator_add(new RVector(0, this.getFloat("HingeInset")
			+ 1 - this.getFloat("HingeHoleClearance")
			- this.getFloat("FrameCBarWidth") / 2
			- this.getFloat("WeldLugHoleWidth") / 2));

	// print ("Length of holes "+startPos.getDistanceTo2d(endPos));

	this.holesBarRBottom = new WeldTabHoleLine(startPos, endPos,
	...
	if (ui.widgets["ThirdHinge"].checked)
		...
		startPos = endPos.operator_add(new RVector(0, this
				.getFloat("HingeHoleClearance") * 2));

		endPos = startPos.operator_add(new RVector(0, this.hingeAssembly
				.getMiddleHingeCentre().getY()
				- this.getFloat("HingeInset")
				- 2
				* this.getFloat("HingeHoleClearance")));

		this.holesBarRLower = new WeldTabHoleLine(startPos, endPos,
				insetStartHole, insetEndHole);
		...
		this.holesBarRUpper = new WeldTabHoleLine(startPos, endPos,
				insetStartHole, insetEndHole);
		...
		endPos = startPos.operator_add(new RVector(0, 2 * (this.hingeAssembly
				.getMiddleHingeCentre().getY()
				- this.getFloat("HingeInset") - this
				.getFloat("HingeHoleClearance"))));
	...
	endPos = startPos.operator_add(new RVector(0, this.getFloat("HingeInset")
			- this.getFloat("HingeHoleClearance") + 1));

	this.holesBarRTop = new WeldTabHoleLine(startPos, endPos, insetStartHole,
			insetEndHole);
	this.holesBarRTop.render(di, ao);

	// Create arc of weld tab holes

	var arc = new WeldTabHoleArc(pos.operator_add(new RVector(width - radius,
			getGothicSpring(radius, width, height))

	), radius - allowance - this.getFloat("FrameCBarWidth") / 2, 0,
			getGothicAngle(radius - allowance, width - 2 * allowance), true,
			true, Math.PI / 18);

	arc.render(di, ao);

	var arc2 = new WeldTabHoleArc(
			pos.operator_add(new RVector(radius, getGothicSpring(radius, width,
					height))
	...
	startPos = pos.operator_add(new RVector(this.getFloat("Allowance")
			+ this.getFloat("FrameCRelativeWidth") / 2
			+ this.getFloat("FrameCBarWidth") / 2
			- this.getFloat("WeldLugHoleWidth") / 2,

	this.getFloat("Allowance") + this.getFloat("FrameCRelativeWidth") / 2
			+ this.getFloat("FrameCBarWidth") / 2

	));

	endPos = pos.operator_add(new RVector(width - this.getFloat("Allowance")
			- this.getFloat("FrameCRelativeWidth") / 2
			- this.getFloat("FrameCBarWidth") / 2
			+ this.getFloat("WeldLugHoleWidth") / 2,
	...
	var holesBarB = new WeldTabHoleLine(startPos, endPos, insetStartHole,
			insetEndHole);
	holesBarB.render(di, ao);

	// Hinge mount holes

	this.hingeAssembly.renderHoles(di, ao, pos.operator_add(new RVector(width
...
// ********************************************************************************************************************
	...
	this.addDimensions(di, ao, pos.operator_add(new RVector(0, 0)), pos
			.operator_add(new RVector(width - 2 * allowance, 0)), pos
			.operator_add(new RVector(0, -50)));
...
// ********************************************************************************************************************
	...
	var holeSpaceAngle = this.holeArc.getAngularSpacing(); // Ten degrees of
	// arc
	var holeArcWidth = width - 2 * allowance - this.getFloat("FrameCBarWidth");

	createArcBar(di, ao, pos.operator_add(new RVector(0, sidebarHeight)),
	...
	this.addDimensions(di, ao, pos, pos.operator_add(new RVector(0,
			sidebarHeight + getGothicArchLength(holeArcRadius, holeArcWidth))),
			pos.operator_add(new RVector(-40, sidebarHeight / 2)));
	};
...
// ********************************************************************************************************************
	...
	var mirror = true;
	var length = ui.getFloat("HingeInset") - ui.getFloat("HingeHoleClearance")
			- this.getFloat("FrameCBarWidth") / 2
			- this.getFloat("WeldLugHoleWidth") / 2;

	var root = new RVector(pos.getX(), this.holesBarRBottom.getStartPos()
			.getY());

	var lugOption = ui.getCombo("RightBar4Lugs");

	createSidebar(di, ao, root, this.holesBarRBottom.getLength(), sidebarWidth,
			mountingLugInset, mountingLugMinSpacing, weldLugInset,
			weldLugWidth, weldLugDepth, weldLugMinSpacing, weldLugMaxSpacing,
			lugHoleDiameter, lugWidth, lugHoleOffset, insetStartTab,
			insetEndTab, suppressTop, mirror, lugOption);
	...
	if (ui.widgets["ThirdHinge"].checked)
		...
		createSidebar(di, ao, new RVector(pos.getX(), this.holesBarRLower
				.getStartPos().getY()), this.holesBarRLower.getLength(),
				...
				insetStartTab, insetEndTab, suppressTop, mirror, ui
						.getCombo("RightBar3Lugs"));

		insetStartTab = false;
		insetEndTab = false;

		createSidebar(di, ao, new RVector(pos.getX(), this.holesBarRUpper
				.getStartPos().getY()), this.holesBarRUpper.getLength(),
				sidebarWidth, mountingLugInset, mountingLugMinSpacing,
				weldLugInset, weldLugWidth, weldLugDepth, weldLugMinSpacing,
				weldLugMaxSpacing, lugHoleDiameter, lugWidth, lugHoleOffset,
				insetStartTab, insetEndTab, suppressTop, mirror, ui
						.getCombo("RightBar2Lugs"));
		...
		//
		//		
		// createSidebar(di, ao, new
		// RVector(pos.getX(),this.holesBarRLower.getStartPos().getY()),
		// this.holesBarRLower.getLength(),sidebarWidth, mountingLugInset,
		// mountingLugMinSpacing, weldLugInset, weldLugWidth, weldLugDepth,
		// weldLugMinSpacing, weldLugMaxSpacing, lugHoleDiameter, lugWidth,
		// lugHoleOffset, insetStartTab,
		// insetEndTab,suppressTop,mirror,ui.getCombo("RightBar3Lugs"));
	...
	createSidebar(di, ao, new RVector(pos.getX(), this.holesBarRTop
			.getStartPos().getY()), this.holesBarRTop.getLength(),
			sidebarWidth, mountingLugInset, mountingLugMinSpacing,
			weldLugInset, weldLugWidth, weldLugDepth, weldLugMinSpacing,
			weldLugMaxSpacing, lugHoleDiameter, lugWidth, lugHoleOffset,
			insetStartTab, insetEndTab, suppressTop, mirror, ui
					.getCombo("RightBar1Lugs"));
	...
	createArcBar(di, ao, root.operator_add(new RVector(0, sidebarHeight)),
			holeArcWidth, holeArcRadius, barWidth, holeSpaceAngle,
			weldLugWidth, weldLugDepth, sidebarWidth);
...
// ********************************************************************************************************************
	...
	createSidebar(di, ao, pos, sidebarHeight, sidebarWidth, mountingLugInset,
			mountingLugMinSpacing, weldLugInset, weldLugWidth, weldLugDepth,
			weldLugMinSpacing, weldLugMaxSpacing, lugHoleDiameter, lugWidth,
			lugHoleOffset, insetStartTab, insetEndTab, false, true, ui
					.getCombo("BottomBarLugs"));
...
//			+ this.getFloat("FrameABarWidth") - this.getFloat("ArchBarWidth"); // TODO
	...
	createRectangle(di, ao, pos.operator_add(new RVector(60, 0)), this
			.getFloat("HoledSimpleBarWidth"), getGothicArchLength(radius_22,
			width_22));
	...
	var firstStartPos = pos.operator_add(new RVector(60 + this
			.getFloat("HoledBarMargin"), this.getFloat("HoledBarBottomInset")));
	var firstEndPos = pos.operator_add(new RVector(60 + this
			.getFloat("HoledBarMargin"), getGothicArchLength(radius_22,
			width_22)
			- this.getFloat("HoledBarTopInset")));
	...
	var secondStartPos = pos.operator_add(new RVector(90 + this
			.getFloat("HoledBarMargin"), this.getFloat("HoledBarBottomInset")));
	var secondEndPos = pos.operator_add(new RVector(90 + this
			.getFloat("HoledBarMargin"), getGothicArchLength(radius_22,
			width_22)
			- this.getFloat("HoledBarTopInset")));
	...
	this.addDimensions(di, ao, pos, pos.operator_add(new RVector(0,
			getGothicArchLength(radius_17, width_17))), pos
			.operator_add(new RVector(-25, getGothicArchLength(radius_17,
					width_17) / 2)));

	this.addDimensions(di, ao, pos.operator_add(new RVector(112, 0)), pos
			.operator_add(new RVector(112, getGothicArchLength(radius_22,
					width_22))), pos.operator_add(new RVector(137,
			getGothicArchLength(radius_22, width_22) / 2)));
...
Gothic.createMasonsOpeningArch = function(di, ao, pos)
	...
	createGothicArchRel(di, ao, pos, radius, width, height, 0);
	}
...
Gothic.createMasonsOpeningDimensions = function(di, ao, pos)
	{
	var width = this.getFloat("MasonsOpeningWidth");
	var height = this.getFloat("MasonsOpeningHeight")

	this.addDimensions(di, ao, pos.operator_add(new RVector(width / 2, 0)), pos
			.operator_add(new RVector(width / 2, height)), pos
			.operator_add(new RVector(-25, height / 2)));

	this.addDimensions(di, ao, pos, pos.operator_add(new RVector(width, 0)),
			pos.operator_add(new RVector(0, -50)));
...
Gothic.createWeldTabHoleLine = function(di, ao, pos, length, width,
		orientation, insetStartHole, insetEndHole)
	{
	...
	createWeldTabHoleLine(di, ao, pos, length, width, minSpacing, maxSpacing,
			orientation, weldLugWidth, weldLugHoleWidth, weldLugHoleClearance,
			weldLugInset, insetStartHole, insetEndHole);
...
//
	...
	for (i = 0; i < layers.length; i++)
		{
		addLayerOperation.addObject(new RLayer(di.getDocument(), layers[i],
				false, false, di.getCurrentColor(), di.getCurrentLinetypeId(),
				RLineweight.Weight005));
		}
...
//
	...
	for (i = 0; i < blocks.length; i++)
		{
		addBlockOperation.addObject(new RBlock(di.getDocument(), blocks[i],
				new RVector(0, 0)));
		}
